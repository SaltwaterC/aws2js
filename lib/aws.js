...
var client = function (config) {
	...
	if (config.prefix == 's3') {
		...
		config.post = function (path, headers, body, callback) {
			...
			internals.standardHeaders(config, 'POST', headers, path, body, function (err, hdrs) {
					if (err) {
						...
						// hdrs.expect = '100-continue'; XXX disabled due to https://github.com/joyent/node/issues/2636
						internals.makeRequest(config, {
							method: 'POST',
							path: path,
							headers: hdrs
		...
		config.putFile = function (path, file, acl, headers, callback) {
			...
			// headers.expect = '100-continue'; XXX disabled due to https://github.com/joyent/node/issues/2636
		...
		config.putFilePart = function (path, partNumber, uploadId, fileHandler, callback) {
			...
			bf.on('end', function () {
				// var headers = {expect: '100-continue'}; XXX disabled due to https://github.com/joyent/node/issues/2636
				var headers = {};
				headers['content-md5'] = md5.digest('base64');
